...
const styles = {
  container: { minHeight: '100vh', backgroundColor: '#f4f6fb' },
  header: {
    display: 'flex',
  ...
  sectionTitle: { marginTop: 0, marginBottom: '16px', color: '#111827' },
  formGrid: {
    display: 'grid',
  ...
  emptyState: { padding: '20px', textAlign: 'center', color: '#6b7280' },
};
